...
Other rules:
- Use bold text sparingly — avoid excessive bold formatting.
...
- Use minimal bold text — avoid heavy bold formatting.
...
- **Do not change, approximate, round, or modify numeric values — keep all numbers exactly as provided in the input.**
